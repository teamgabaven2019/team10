...
module.exports = RemotePanel = (function(_super) {
  ...
  RemotePanel.prototype.initialize = function() {
    var div, div2, icon, listdiv, toolbar;
    div = DT.DIV();
    ...
    listdiv.appendChild(this.targetList.getElement());
  ...
  RemotePanel.prototype.setTargetName = function(device_id, device_name) {
    return this.targetList.setName(device_id, device_name);
  };
...
TargetList = (function(_super) {
  ...
  function TargetList() {
    ...
    this.ulConnectors.addEventListener("change", (function(e) {
      var channel;
      channel = _this.ulConnectors.value;
      return _this.connectToTarget(channel, e);
    }), false);
    this.nameList = {};
    this.optionElements = {};
  }

  TargetList.prototype.setName = function(device_id, device_name) {
    this.nameList[device_id] = device_name;
    return this.refresh(device_id);
  };

  TargetList.prototype.getListItem = function(target) {
    var device_id, index, item, myUrl, name, parser, self, text;
    self = this;
    ...
    name = "Unknown Device";
    for (device_id in this.nameList) {
      if (target.channel.indexOf(device_id) !== -1) {
        name = this.nameList[device_id];
        break;
      }
    }
    text = ("" + name + ": ") + myUrl;
    ...
    target.element = item;
    this.optionElements[target.channel] = target.element;
    return item;
  };
